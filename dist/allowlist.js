...
var _simpleList = {
    1: {
        ...
        '0xc36cb218848F173148ff55f4dfC18f1540FB7475': 'Blue Chips',
    ...
    // Goerli
    5: {
        '0xAEdEDf4A27d4Ea6f658b5F69F70a72d12BDeb937': 'Proton A-i',
        '0xEDa5dA03bB30f7137F00787edAee84ae4fD54905': 'Proton A-ii',
        '0xfb6075A3f960DBcd28Ae4Bb45092ce33D2909060': 'Proton A-iii',
        '0xd1bCe91a13089b1f3178487aB8d0d2Ae191C1963': 'Proton B-i',
        '0x1554b19E1eD9FE78F375AC7c8F63Fe9E85d15a16': 'Proton B-ii',
        '0x517fEfB53b58Ec8764ca885731Db20Ca2dcac7b7': 'Proton B-iii',
        '0xF0e4ed501ED7d960886e3f9E8d569e1a1253Eb53': 'Proton B-iv',
        '0x6D05f07c30be99317D649302dA2054C667Cdd93D': 'Proton C (Soul)',
        '0xc191e3De6e8ab034Adc4B199749F7199DA9a98e6': 'Lepton 2',
        '0xef815ad5401cee4b8b2e6bc2f8c481d84e5d0871': 'External NFT Example Contract - Goerli',
    },
    // Kovan (Deprecated)
    42: {
        '0xf5891837cc808f8d20a76c6a5db5a0c5374b6a1b': 'Proton C (Soul)',
        '0xef815ad5401cee4b8b2e6bc2f8c481d84e5d0871': 'External NFT Example Contract - Kovan',
    },
    // Polygon
    137: {
    ...
    80001: {
        ...
        '0xC5b2d04669b6B701195F90c15C560edaa3509C92': 'Web3Packs',
...
exports.allowlist = {};
// Iterate All Chains
Object.keys(_simpleList).forEach(function (chainIdStr) {
    var chainId = parseInt(chainIdStr, 10);
    exports.allowlist[chainId] = {};
    // Iterate All Contracts for Chain
    Object.keys(_simpleList[chainId]).forEach(function (contractAddress) {
        // Build Allowlist Object
        exports.allowlist[chainId][contractAddress.toLowerCase()] = {
            address: contractAddress.toLowerCase(),
            name: _simpleList[chainId][contractAddress]
        };
    });
});
